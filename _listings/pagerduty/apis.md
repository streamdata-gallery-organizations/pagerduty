...
- name: PagerDuty - Teams Resource
  ...
  tags: Notifications, Incident, Monitoring, Stack Network, SaaS, Technology, Enterprise,
    Relative Data, Service API, Relative StreamRank, Streams, Webhook Implementations
  properties:
...
- name: PagerDuty - Users {user_guid}
  x-api-slug: usersuser-guid-delete
...
- name: PagerDuty - List escalation policies
  x-api-slug: escalation-policies-get
...
- name: PagerDuty - Create an escalation policy
  x-api-slug: escalation-policies-post
...
- name: PagerDuty - Get an escalation policy
  x-api-slug: escalation-policiesid-get
...
- name: PagerDuty - Delete an escalation policy
  x-api-slug: escalation-policiesid-delete
...
- name: PagerDuty - Update an escalation policy
  x-api-slug: escalation-policiesid-put
...
- name: PagerDuty - List log entries for the incident
  x-api-slug: incidentsidlog-entries-get
...
- name: PagerDuty - List existing notes for the specified incident
  x-api-slug: incidentsidnotes-get
...
- name: PagerDuty - Create a new note for the specified incident
  x-api-slug: incidentsidnotes-post
...
- name: PagerDuty - Snooze an incident
  x-api-slug: incidentsidsnooze-post
...
- name: PagerDuty - List maintenance windows
  x-api-slug: maintenance-windows-get
...
- name: PagerDuty - Create a maintenance window
  x-api-slug: maintenance-windows-post
...
- name: PagerDuty - Get a maintenance window
  x-api-slug: maintenance-windowsid-get
...
- name: PagerDuty - Delete or end a maintenance window
  x-api-slug: maintenance-windowsid-delete
...
- name: PagerDuty - Update a maintenance window
  x-api-slug: maintenance-windowsid-put
...
- name: PagerDuty - Create a new integration
  x-api-slug: servicesidintegrations-post
...
- name: PagerDuty - Update an existing integration
  x-api-slug: servicesidintegrationsintegration-id-put
...
- name: PagerDuty - View an integration
  x-api-slug: servicesidintegrationsintegration-id-get
...
- name: PagerDuty - Remove a user from a team
  x-api-slug: teamsidusersuser-id-delete
...
- name: PagerDuty - Add a user to a team
  x-api-slug: teamsidusersuser-id-put
...
- name: PagerDuty - List a user's notification rules
  x-api-slug: usersidnotification-rules-get
...
- name: PagerDuty - Create a user notification rule
  x-api-slug: usersidnotification-rules-post
...
- name: PagerDuty - Get a user's notification rule
  x-api-slug: usersidnotification-rulesnotification-rule-id-get
...
- name: PagerDuty - Delete a user's notification rule
  x-api-slug: usersidnotification-rulesnotification-rule-id-delete
...
- name: PagerDuty - Update a user's notification rule
  x-api-slug: usersidnotification-rulesnotification-rule-id-put
